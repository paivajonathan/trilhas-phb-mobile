...
class HikeChoiceScreen extends StatefulWidget {
  const HikeChoiceScreen({super.key});

  @override
  State<HikeChoiceScreen> createState() => _HikeChoiceScreenState();
}

class _HikeChoiceScreenState extends State<HikeChoiceScreen> {
                    ...
                    if (snapshot.data!.isEmpty) {
                      return Stack(
                        children: <Widget>[
                          const Center(
                            child: Text(
                              "As trilhas cadastradas aparecerão aqui.",
                            ),
                          ),
                          ListView()
                        ],
